"""
Django settings for eva2_cloud project.
...
SECRET_KEY = 'django-insecure-)yrilzza8_$tl1cd5kc8$&$9mtn!+lhg(+y280dyql@a)xfx8j'
...
WSGI_APPLICATION = 'eva2_cloud.wsgi.application'
